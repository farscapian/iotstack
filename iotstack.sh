...
_require_websocat() {
  ...
  warn "websocat not found (required for Home Assistant device/area lookups). Re-run setup.sh to install it."
  return 1
}
...
cmd_clean() {
  ...
  # Honor overrides from ~/.iotstack/environments/default.env when paths differ from defaults
