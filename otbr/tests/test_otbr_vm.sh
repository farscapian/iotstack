...
# ot-cli binary at cache/ot-rcp-sim/ot-cli (built automatically by otbr vm).
#
...
# Cleanup
# ---------------------------------------------------------------------------
# shellcheck disable=SC2329  # called indirectly via trap EXIT
_cleanup() {
...
# shellcheck disable=SC2016  # single quotes intentional: remote shell commands
